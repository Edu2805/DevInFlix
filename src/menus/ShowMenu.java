	...
	public void menuUsuario() {
		...
		while (entrarMenu != 2) {
			...
			while(!stopWhileNovoFilme) {
				System.out.print("Olá " + listaDeUsuarios.getNomeCompleto() + ", escolha um dos filmes para você assistir: ");
				escolhaFilme = sc.nextInt() - 1;
				sc.nextLine();
				listaDeUsuarios.escolhaDoFilme(escolhaFilmesDaLista, escolhaFilme);
				generosMaisUsuarios.generosMaisAssistidosUsuario(escolhaFilmesDaLista, cadastroUsuarios, escolhaFilme, secaoUsuario);
				generosMaisPlataforma.generosMaisAssistidosPlataforma(escolhaFilmesDaLista, cadastroUsuarios, escolhaFilme, secaoUsuario);
					...
					if (controleLista == 2) {
						...
						for (int h = 0; h < cadastroUsuarios.size(); h++) {
							if (escolha <= cadastroUsuarios.size()) {
								...
								System.out.println(
										"----------------------------------------------------------------------------");
								// Método para Recomendacoes de filmes
			...
			SomaGenerosUsuarios comparaGenerosMaisUsuarios = new SomaGenerosUsuarios(acaoUsuario, aventuraUsuario, romanceUsuario, cartoonUsuario, dramaUsuario, documentarioUsuario, independentesUsuario, suspenseUsuario, outrosUsuario);
			SomaGenerosPlataforma comparaGenerosMaisPlataforma = new SomaGenerosPlataforma(acaoPlataforma, aventuraPlataforma, romancePlataforma, cartoonPlataforma, dramaPlataforma, documentarioPlataforma, independentesPlataforma, suspensePlataforma, outrosPlataforma);
			
			//Generos mais assistidos plataforma
